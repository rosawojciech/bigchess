#' Plot the tree for a move tree table
#'
#' This function creates a bar plot of the outcomes of a set of chess games
#' based on a move tree.
#'
#' @details The function takes a data frame of move tree data from `tree_move()`
#'   as an argument. The bar plot shows the percentage of games that resulted in
#'   a win, loss, or draw based on the moves made. The weighted mean of the
#'   percentages is also shown.
#'
#' @param tr A data frame containing move tree data.
...
#'   labels.
#'
#' @return A barplot of the percentage of wins, losses, and draws based on
#'   moves.
#'
#' @examples
...
#'
#' @export
plot_tree_move <- function(tr, main = "", add.lines = TRUE, add.labels = TRUE) {
